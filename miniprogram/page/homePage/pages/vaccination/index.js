// page/homePage/pages/vaccination/index.js
...
CustomPage({
  onShareAppMessage() {
    return {
      title: '知萌-疫苗接种',
      path: 'page/homePage/pages/vaccination/index'
    }
  },
  data: {
    selected: 0,
    lst_hospital_info:[
      {
        hospital_name:'医院A',
        hospital_distance:'x',
        hospital_tag:'疫苗；普通外科；狗证；体检'
      },
      {
        hospital_name:'医院B',
        hospital_distance:'y',
        hospital_tag:'24小时急诊；疫苗；体检；牙科'
      },
     {
      hospital_name:'医院C',
      hospital_distance:'z',
      hospital_tag:'疫苗；美容；狗证'
     },
    ],
