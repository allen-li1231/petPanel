// page/homePage/pages/physical-examination/index.js
...
AOPage({
  onShareAppMessage() {
    return {
      title: '知萌-体检',
      path: 'page/homePage/pages/physical-examination/index'
    }
  },
  data: {
    selected: 0,
    lst_hospital_info:[
      {
        hospital_name:'医院A',
        hospital_distance:'x',
        hospital_tag:'美容；普通外科；狗证；体检'
      },
      {
        hospital_name:'医院B',
        hospital_distance:'y',
        hospital_tag:'24小时急诊；狗证；体检；牙科'
      },
     {
      hospital_name:'医院C',
      hospital_distance:'z',
      hospital_tag:'体检；美容；狗证'
     },
    ],
